...
create table T_ACCOUNT (ID integer identity primary key, ACCOUNT_UUID UUID UNIQUE, OVERDRAFT decimal(9,2), BALANCE decimal(9,2), NAME varchar(50) not null, VERSION numeric not null);
