...
create table T_TRANSFER (ID integer identity primary key, FROM_ACCOUNT UUID not null, TO_ACCOUNT UUID not null, STATUS_ID integer not null, TRANSFER_DATE date not null, AMOUNT decimal(8,2) not null);
