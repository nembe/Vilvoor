...
import nl.nanda.domain.EmptyAnanieFactory;
...
public class TransferServiceImpl implements TransferService {
	...
	public Account getAccount(final String id) {
		...
		if (account == null) {
			account = EmptyAnanieFactory.getEmptyAccount();
		}
		return account;
	}
	...
	public Transfer findTransferById(final Integer id) {
		...
		if (transfer == null) {
			transfer = EmptyAnanieFactory.getEmptyTransfer();
		}
		return transfer;
	}
	...
	public Transaction findTransaction(final Integer id) {
		...
		if (transaction == null) {
			transaction = EmptyAnanieFactory.getEmptyTransaction();
		}
		return transaction;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see nl.nanda.service.TransferService#findTransactionByAccount(java.lang.
	 * String )
	 */
	/*
	 * @see nl.nanda.service.TransferService#findTransactionByAccount(java.lang.
	...
	public List<Transaction> findTransactionByAccount(final String id) {
		...
		if (transactionList == null || transactionList.isEmpty()) {
			final Transaction transact = EmptyAnanieFactory.getEmptyTransaction();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see nl.nanda.service.TransferService#findTransactionByTransfer(nl.nanda.
	 * transfer .Transfer)
	 */
	/*
	 * @see nl.nanda.service.TransferService#findTransactionByTransfer(nl.nanda.
