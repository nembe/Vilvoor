...
public class AatAccountRepoTest extends AbstractConfig {
	...
	public void testFindAccountByName() {
		...
		final Account account = AccountFactory.createAccounts(1000.50, 0.0, "Jorka1");
		accountRepo.save(account);
		final Account accountFound = accountRepo.findAccountByName(account.getName());
	...
	public void testFindAccountByUUID() {
		...
		final Account account = AccountFactory.createAccounts(1000.50, 20.0, "Coemba");
		final Account accountSave = accountRepo.save(account);

		final Account accountFound = accountRepo.findAccountByUuid(accountSave.getAccountUUID());
	...
	public void testAccountUUID() {
		...
		assertTrue(accountSave.getAccountUUID().equals(account.getAccountUUID()));
	...
	public void testAccountAmount() {
		...
		final Account account = AccountFactory.createAccounts(1020.50, 0.00, "Jorka2");
	...
	public void testAccountBalance() {
		...
		final Account account = AccountFactory.createAccounts(1000.50, 20.00, "Jorka3");
	...
	public void testUpdatingAccountBalanceByQuery() {
		...
		accountRepo.updateAccountBalance(BigDecimal.valueOf(1000.50), account.getAccountUUID());
		final Account accountSave = accountRepo.findAccountByUuid(account.getAccountUUID());
