...
create table T_ACCOUNT (ID integer identity primary key, ACCOUNT_UUID UUID UNIQUE, OVERDRAFT decimal(8,2), BALANCE decimal(8,2), NAME varchar(50) not null, VERSION numeric(2,2) );
